...
<div style="display:none;" id="myDiv" class="animate-bottom fixed-position">
    ...
    <div class="row topper" style="padding:0px; margin-top:30px; font-size:20px">
        TOTAL INCENTIVE AMOUNT
        <?php echo "[ ".$distributor[0]['first_name']." ".$distributor[0]['last_name']." ] = Rp ".number_format(($total_insentif_acq+$total_insentif_trx+$total_insentif_topup+$total_insentif_posm),2,",","."); ?> 
    </div>
