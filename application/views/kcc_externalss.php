...
<div class="row" style="padding:0px; margin-top:30px; font-size:20px">
    TOTAL INCENTIVE AMOUNT <?php echo "[ ".$distributor[0]['first_name']." ".$distributor[0]['last_name']." ] = Rp ".number_format((($net_acq_calc*45000)+(($topupSum1*0.005)+($topupSum2*0.0075)+($topupSum3*0.01)) + (($transSum1*0.005)+($transSum2*0.0075)+($transSum3*0.01))),2,",","."); ?> 
</div>
